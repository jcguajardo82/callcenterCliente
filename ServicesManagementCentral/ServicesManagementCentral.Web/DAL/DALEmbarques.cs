...
namespace ServicesManagement.Web.DAL.Embarques
{
    public class DALEmbarques
    {
        ...
        public static DataSet upCorpOms_Cns_UeNoTrackingInfoExist(string UeNo)
        {
            ...
            try
            {
                ...
                ds = Soriana.FWK.FmkTools.SqlHelper.ExecuteDataSet(CommandType.StoredProcedure, "[dbo].[upCorpOms_Cns_UeNoTrackingInfoExist]", false, parametros);
